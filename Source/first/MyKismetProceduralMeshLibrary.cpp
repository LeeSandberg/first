...
//Happy Message
FString UMyKismetProceduralMeshLibrary::GetHappyMessage()
{
	return FString("Victory! Victory BP Library Works!");
}

void UMyKismetProceduralMeshLibrary::GenerateBoxMesh(FVector BoxRadius, TArray<FVector>& Vertices, TArray<int32>& Triangles, TArray<FVector>& Normals, TArray<FVector2D>& UVs, TArray<FProcMeshTangent>& Tangents)
{
	// Generate verts
	FVector BoxVerts[8];
...
/*
bool UMyKismetProceduralMeshLibrary::SaveStringTextToFile(
